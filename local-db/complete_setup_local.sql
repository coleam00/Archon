-- =====================================================
-- Archon Complete Database Setup (LOCAL DATABASE MODE)
-- =====================================================
-- This is a modified version of complete_setup.sql for local
-- PostgreSQL + PostgREST deployments.
--
-- Key differences from the Supabase version:
-- - No auth.role() references (Supabase Auth is not available)
-- - RLS policies use public role instead of auth.role()
-- - All tables are accessible via PostgREST without authentication
--
-- This file is automatically loaded when LOCAL_DB=true
-- =====================================================
...
-- RLS for local mode: allow public access (no Supabase Auth)
ALTER TABLE archon_settings ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Allow public full access to archon_settings" ON archon_settings;
CREATE POLICY "Allow public full access to archon_settings" ON archon_settings
    FOR ALL USING (true);
...
DROP POLICY IF EXISTS "Allow public full access to archon_page_metadata" ON archon_page_metadata;
CREATE POLICY "Allow public full access to archon_page_metadata" ON archon_page_metadata
    FOR ALL USING (true);
...
-- =====================================================
-- SECTION 6: RLS POLICIES FOR KNOWLEDGE BASE (LOCAL MODE)
-- =====================================================
...
DROP POLICY IF EXISTS "Allow public full access to archon_crawled_pages" ON archon_crawled_pages;
DROP POLICY IF EXISTS "Allow public full access to archon_sources" ON archon_sources;
DROP POLICY IF EXISTS "Allow public full access to archon_code_examples" ON archon_code_examples;

CREATE POLICY "Allow public full access to archon_crawled_pages" ON archon_crawled_pages
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_sources" ON archon_sources
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_code_examples" ON archon_code_examples
    FOR ALL USING (true);
...
DROP POLICY IF EXISTS "Allow public full access to archon_migrations" ON archon_migrations;
CREATE POLICY "Allow public full access to archon_migrations" ON archon_migrations
    FOR ALL USING (true);
...
-- =====================================================
-- SECTION 9: RLS POLICIES FOR PROJECTS MODULE (LOCAL MODE)
-- =====================================================
...
DROP POLICY IF EXISTS "Allow public full access to archon_projects" ON archon_projects;
DROP POLICY IF EXISTS "Allow public full access to archon_tasks" ON archon_tasks;
DROP POLICY IF EXISTS "Allow public full access to archon_project_sources" ON archon_project_sources;
DROP POLICY IF EXISTS "Allow public full access to archon_document_versions" ON archon_document_versions;
DROP POLICY IF EXISTS "Allow public full access to archon_prompts" ON archon_prompts;

CREATE POLICY "Allow public full access to archon_projects" ON archon_projects
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_tasks" ON archon_tasks
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_project_sources" ON archon_project_sources
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_document_versions" ON archon_document_versions
    FOR ALL USING (true);

CREATE POLICY "Allow public full access to archon_prompts" ON archon_prompts
    FOR ALL USING (true);
...
2. Workflow
    1.    Classify requests → Decide which document type fits best:
...
-- =====================================================
-- SETUP COMPLETE (LOCAL DATABASE MODE)
-- =====================================================
-- Your local Archon database is now fully configured!
--
