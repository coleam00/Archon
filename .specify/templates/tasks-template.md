...
**Tests**: Include test tasks for every behavior, API, schema, workflow, or
lifecycle change identified in plan.md. Omit tests only for documentation-only
or mechanical generated-file changes and record the rationale in plan.md.
...
- [ ] T010 Identify package-boundary seams and generated artifacts from Constitution Check
...
### Tests for User Story 1 (when required by plan.md) ⚠️
...
- [ ] T017 [US1] Add validation and classified error handling
...
### Tests for User Story 2 (when required by plan.md) ⚠️
...
### Tests for User Story 3 (when required by plan.md) ⚠️
...
- [ ] TXXX [P] Additional unit tests required by plan.md in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Update generated artifacts required by Constitution Check
- [ ] TXXX Run `bun run validate`
