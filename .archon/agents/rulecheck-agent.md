...
hooks:
  ...
  PreToolUse:
    - matcher: "Bash"
      hooks:
        - type: command
          command: ".archon/skills/rulecheck/hooks/block-dangerous.sh"
          statusMessage: "Checking command safety..."
  Stop:
    - hooks:
        - type: command
          command: ".archon/skills/rulecheck/hooks/slack-notify.sh"
        ...
        - type: agent
          prompt: |
            ...
            Write structured feedback to `.archon/agent-memory/rulecheck-agent/meta-judge-feedback.md`:
...
Your working directory MUST contain `.archon/worktrees/` in the path. If it
