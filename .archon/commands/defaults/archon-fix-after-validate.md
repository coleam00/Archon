---
description: Apply production-code fixes after a failed validation cycle. Reads the latest validator instructions and review verdict; edits production source only.
argument-hint: (none - reads latest dev/validation state from $ARTIFACTS_DIR)
---
