...
description: Attack a functional specification with parallel adversarial lens agents
  before /speckit.plan locks in architecture. Aggregates findings and walks the maintainer
  through resolution into one of four categories.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: red-team:commands/red-team.md
---
