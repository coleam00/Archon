...
This guide helps contributors work effectively on the Archon V2 Beta codebase. The project is local‑only, iterates fast, and favors detailed errors for quick fixes.
