...
Either way prefer removing work over widening the window: #2310 dropped a `tar` spawn for an in-process fixture, and #2306 stopped a dry run creating a database.
