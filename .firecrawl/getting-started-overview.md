[Skip to content](https://archon.diy/getting-started/overview/#_top)
...
- [Overview](https://archon.diy/getting-started/overview/#_top)
- [Prerequisites](https://archon.diy/getting-started/overview/#prerequisites)
- [Step 1: Clone and Install](https://archon.diy/getting-started/overview/#step-1-clone-and-install)
- [Step 2: Set Up Authentication](https://archon.diy/getting-started/overview/#step-2-set-up-authentication)
  - [GitHub Token](https://archon.diy/getting-started/overview/#github-token)
  - [Claude Authentication](https://archon.diy/getting-started/overview/#claude-authentication)
- [Step 3: Create Your .env File](https://archon.diy/getting-started/overview/#step-3-create-your-env-file)
- [Choose Your Path](https://archon.diy/getting-started/overview/#choose-your-path)
  - [Path A: Web UI (Server)](https://archon.diy/getting-started/overview/#path-a-web-ui-server)
  - [Path B: CLI (No Server)](https://archon.diy/getting-started/overview/#path-b-cli-no-server)
- [CLI Reference](https://archon.diy/getting-started/overview/#cli-reference)
  - [Workflows](https://archon.diy/getting-started/overview/#workflows)
  - [CLI Commands](https://archon.diy/getting-started/overview/#cli-commands)
  - [Worktree Management](https://archon.diy/getting-started/overview/#worktree-management)
  - [Available Workflows](https://archon.diy/getting-started/overview/#available-workflows)
- [Customize Your Target Repo](https://archon.diy/getting-started/overview/#customize-your-target-repo)
  - [Custom Commands](https://archon.diy/getting-started/overview/#custom-commands)
  - [Custom Workflows](https://archon.diy/getting-started/overview/#custom-workflows)
- [Isolation (Worktrees)](https://archon.diy/getting-started/overview/#isolation-worktrees)
- [Using With Claude Code (Skill)](https://archon.diy/getting-started/overview/#using-with-claude-code-skill)
- [Running the Full Platform (Server + Chat Adapters)](https://archon.diy/getting-started/overview/#running-the-full-platform-server--chat-adapters)
- [Troubleshooting](https://archon.diy/getting-started/overview/#troubleshooting)
  - [”Cannot create worktree: not in a git repository” (but the repo exists)](https://archon.diy/getting-started/overview/#cannot-create-worktree-not-in-a-git-repository-but-the-repo-exists)
  - [”command not found: bun”](https://archon.diy/getting-started/overview/#command-not-found-bun)
  - [“command not found: claude”](https://archon.diy/getting-started/overview/#command-not-found-claude)
  - [Port 3090 already in use](https://archon.diy/getting-started/overview/#port-3090-already-in-use)
  - [Web UI shows “disconnected”](https://archon.diy/getting-started/overview/#web-ui-shows-disconnected)
  - [Clone command fails with 401/403](https://archon.diy/getting-started/overview/#clone-command-fails-with-401403)
  - [AI doesn’t respond](https://archon.diy/getting-started/overview/#ai-doesnt-respond)
  - [“Cannot find module” or dependency errors](https://archon.diy/getting-started/overview/#cannot-find-module-or-dependency-errors)
- [Quick Reference](https://archon.diy/getting-started/overview/#quick-reference)
- [What’s Next?](https://archon.diy/getting-started/overview/#whats-next)
  - [Add a chat platform (optional)](https://archon.diy/getting-started/overview/#add-a-chat-platform-optional)
  - [Create custom commands and workflows](https://archon.diy/getting-started/overview/#create-custom-commands-and-workflows)
  - [Deploy to a server](https://archon.diy/getting-started/overview/#deploy-to-a-server)
- [Further Reading](https://archon.diy/getting-started/overview/#further-reading)
...
[Section titled “Prerequisites”](https://archon.diy/getting-started/overview/#prerequisites)
...
[Section titled “Step 1: Clone and Install”](https://archon.diy/getting-started/overview/#step-1-clone-and-install)
...
[Section titled “Step 2: Set Up Authentication”](https://archon.diy/getting-started/overview/#step-2-set-up-authentication)

You need two things: a GitHub token (for cloning repos) and Claude authentication (for the AI assistant).

### GitHub Token

[Section titled “GitHub Token”](https://archon.diy/getting-started/overview/#github-token)
...
[Section titled “Claude Authentication”](https://archon.diy/getting-started/overview/#claude-authentication)
...
[Section titled “Step 3: Create Your .env File”](https://archon.diy/getting-started/overview/#step-3-create-your-env-file)
...
[Section titled “Choose Your Path”](https://archon.diy/getting-started/overview/#choose-your-path)

### Path A: Web UI (Server)

[Section titled “Path A: Web UI (Server)”](https://archon.diy/getting-started/overview/#path-a-web-ui-server)
...
Open **[http://localhost:5173](http://localhost:5173/)** in your browser. You should see the Archon Web UI.
...
[Section titled “Path B: CLI (No Server)”](https://archon.diy/getting-started/overview/#path-b-cli-no-server)
...
[Section titled “CLI Reference”](https://archon.diy/getting-started/overview/#cli-reference)

### Workflows

[Section titled “Workflows”](https://archon.diy/getting-started/overview/#workflows)
...
[Section titled “CLI Commands”](https://archon.diy/getting-started/overview/#cli-commands)
...
[Section titled “Worktree Management”](https://archon.diy/getting-started/overview/#worktree-management)
...
[Section titled “Available Workflows”](https://archon.diy/getting-started/overview/#available-workflows)
...
[Section titled “Customize Your Target Repo”](https://archon.diy/getting-started/overview/#customize-your-target-repo)
...
[Section titled “Custom Commands”](https://archon.diy/getting-started/overview/#custom-commands)
...
[Section titled “Custom Workflows”](https://archon.diy/getting-started/overview/#custom-workflows)
...
[Section titled “Isolation (Worktrees)”](https://archon.diy/getting-started/overview/#isolation-worktrees)
...
[Section titled “Using With Claude Code (Skill)”](https://archon.diy/getting-started/overview/#using-with-claude-code-skill)
...
[Section titled “Running the Full Platform (Server + Chat Adapters)”](https://archon.diy/getting-started/overview/#running-the-full-platform-server--chat-adapters)
...
[Section titled “Troubleshooting”](https://archon.diy/getting-started/overview/#troubleshooting)

### ”Cannot create worktree: not in a git repository” (but the repo exists)

[Section titled “”Cannot create worktree: not in a git repository” (but the repo exists)”](https://archon.diy/getting-started/overview/#cannot-create-worktree-not-in-a-git-repository-but-the-repo-exists)
...
[Section titled “”command not found: bun””](https://archon.diy/getting-started/overview/#command-not-found-bun)

Install Bun: `curl -fsSL https://bun.sh/install | bash`, then restart your terminal (or `source ~/.bashrc`).

### “command not found: claude”

[Section titled ““command not found: claude””](https://archon.diy/getting-started/overview/#command-not-found-claude)
...
[Section titled “Port 3090 already in use”](https://archon.diy/getting-started/overview/#port-3090-already-in-use)
...
[Section titled “Web UI shows “disconnected””](https://archon.diy/getting-started/overview/#web-ui-shows-disconnected)
...
[Section titled “Clone command fails with 401/403”](https://archon.diy/getting-started/overview/#clone-command-fails-with-401403)
...
[Section titled “AI doesn’t respond”](https://archon.diy/getting-started/overview/#ai-doesnt-respond)
...
[Section titled ““Cannot find module” or dependency errors”](https://archon.diy/getting-started/overview/#cannot-find-module-or-dependency-errors)
...
[Section titled “Quick Reference”](https://archon.diy/getting-started/overview/#quick-reference)
...
| API server          | [http://localhost:3090](http://localhost:3090/) |
...
[Section titled “What’s Next?”](https://archon.diy/getting-started/overview/#whats-next)

### Add a chat platform (optional)

[Section titled “Add a chat platform (optional)”](https://archon.diy/getting-started/overview/#add-a-chat-platform-optional)

Want to message Archon from your phone? Pick one:

| Platform            | Difficulty      | Guide                                                           |
| ------------------- | --------------- | --------------------------------------------------------------- |
| **Telegram**        | Easy (5 min)    | [Adapter Setup](https://archon.diy/adapters/telegram/)          |
| **Discord**         | Easy (5 min)    | [Adapter Setup](https://archon.diy/adapters/community/discord/) |
| **Slack**           | Medium (15 min) | [Adapter Setup](https://archon.diy/adapters/slack/)             |
| **GitHub Webhooks** | Medium (15 min) | [Adapter Setup](https://archon.diy/adapters/github/)            |

### Create custom commands and workflows

[Section titled “Create custom commands and workflows”](https://archon.diy/getting-started/overview/#create-custom-commands-and-workflows)
...
[Section titled “Deploy to a server”](https://archon.diy/getting-started/overview/#deploy-to-a-server)

For always-on access from any device, see the [Docker Deployment Guide](https://archon.diy/deployment/docker/).

---

## Further Reading

[Section titled “Further Reading”](https://archon.diy/getting-started/overview/#further-reading)

- [Configuration](https://archon.diy/getting-started/configuration/) — All configuration options
- [AI Assistants](https://archon.diy/getting-started/ai-assistants/) — Claude and Codex setup details
- [CLI Reference](https://archon.diy/reference/cli/) — Full CLI documentation
- [Authoring Workflows](https://archon.diy/guides/authoring-workflows/) — Creating custom workflows

[Edit page](https://github.com/coleam00/Archon/edit/main/packages/docs-web/src/content/docs/getting-started/overview.md)

[Previous \\
\\
Installation](https://archon.diy/getting-started/installation/) [Next \\
\\
Core Concepts](https://archon.diy/getting-started/concepts/)
