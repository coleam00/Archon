![Archon](https://raw.githubusercontent.com/coleam00/Archon/main/assets/logo.png)

# Archon

The first open-source harness builder for AI coding. Make AI coding deterministic and repeatable.

[![coleam00%2FArchon | Trendshift](https://trendshift.io/api/badge/repositories/13964)](https://trendshift.io/repositories/13964)

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://raw.githubusercontent.com/coleam00/Archon/main/LICENSE)[![CI](https://github.com/coleam00/Archon/actions/workflows/test.yml/badge.svg)](https://github.com/coleam00/Archon/actions/workflows/test.yml)[![Docs](https://img.shields.io/badge/docs-archon.diy-blue)](https://archon.diy/)
...
nodes:
 ...
 until: ALL\_TASKS\_COMPLETE
 fresh\_context: true # Fresh session each iteration

 \- id: run-tests
 depends\_on: \[implement\]
 bash: "bun run validate" # Deterministic - no AI

 \- id: review
 depends\_on: \[run-tests\]
