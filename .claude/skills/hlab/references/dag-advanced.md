...
The Codex CLI picks up all of these automatically because HarneesLab inherits the full process environment when spawning the CLI. No HarneesLab configuration needed — just set up the Codex CLI config once.
