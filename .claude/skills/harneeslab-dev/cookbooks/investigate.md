...
**Next steps**:
- To write requirements: `/harneeslab-dev prd {recommended approach}`
- To plan implementation: `/harneeslab-dev plan {recommended approach}`
- For deeper codebase context: `/harneeslab-dev research {specific component}`
