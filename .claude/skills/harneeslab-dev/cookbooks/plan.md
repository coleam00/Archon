...
Save to `.claude/harneeslab/plans/{slug}.plan.md` where `{slug}` is a kebab-case feature name.
...
**File**: `.claude/harneeslab/plans/{slug}.plan.md`
...
**Next Step**: `/harneeslab-dev implement .claude/harneeslab/plans/{slug}.plan.md`
```
