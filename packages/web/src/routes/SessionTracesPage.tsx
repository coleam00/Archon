    ...
    <div className="flex h-full flex-1 flex-col gap-6 overflow-y-auto p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-text-secondary">
          ...
          regenerated by{' '}
          <code className="rounded bg-surface px-1">build-cc-session-traces-json.py</code> on the
          dashboard cron. Tool-call bodies and full transcripts are stripped at build time per the
          2026-06-11 D3 decision (Greg Queue B).
        </p>
