 ...
 *     Scoping is the server's job (#3135): on an install where identity
 *     arrives, the list is already narrowed to the caller's own conversations
 *     and an unresolved identity is a 401; on a solo install it is open.
