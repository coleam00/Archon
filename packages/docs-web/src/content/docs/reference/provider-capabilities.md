...
| Capability | `claude` | `codex` | `ollama` | `opencode` | `pi` | `copilot` | `aiderdesk` |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Session resume | ✅ | ✅ | ❌ | ✅ | ✅ | ✅ | ✅ |
| MCP servers (`mcp:`) | ✅ | ✅ | ❌ | ❌ | ❌ | ✅ | ❌ |
| Hooks (`hooks:`) | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
| Structured output (`output_format`) | **enforced** | **enforced** | best-effort | **enforced** | best-effort | best-effort | best-effort |
| Env injection (`env:`) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
