...
- `grok` — Grok (xAI) *(community provider)*

## Capabilities

| Capability | `claude` | `codex` | `opencode` | `pi` | `copilot` | `grok` |
| --- | --- | --- | --- | --- | --- | --- |
| Session resume | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| Structured output (`output_format`) | **enforced** | **enforced** | **enforced** | best-effort | best-effort | **enforced** |
| Env injection (`env:`) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
