---
title: Slack
description: Socket Mode로 HarneesLab을 Slack에 연결합니다. 공개 URL 없이 방화벽 뒤에서도 동작합니다.
category: adapters
area: adapters
...
HarneesLab을 Slack에 연결하면 어떤 Slack workspace에서든 AI 코딩 어시스턴트와 상호작용할 수 있습니다.
...
HarneesLab은 Slack 연동에 **Socket Mode**를 사용합니다. 이는 다음을 의미합니다.
