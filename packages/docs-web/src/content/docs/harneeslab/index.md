...
다음 단계는 [한글화 로드맵](/harneeslab/roadmap/)에서 관리합니다.

## 빠른 시작 경로

- 처음 방향을 잡을 때: [시작 안내](/harneeslab/start-here/)
- 작업 순서를 볼 때: [한글화 로드맵](/harneeslab/roadmap/)
- 번역 표현을 고정할 때: [한글화 용어집](/harneeslab/glossary/)
