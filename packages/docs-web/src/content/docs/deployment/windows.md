...
HarneesLab CLI는 Unix 전용 기능과 tool에 의존합니다.
...
```bash
hlab workflow run assist --cwd /mnt/c/Users/YourName/Projects/my-repo "What does this code do?"
```
