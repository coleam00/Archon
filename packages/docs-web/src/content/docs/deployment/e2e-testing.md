---
title: E2E Testing
description: HarneesLab workflow에서 end-to-end browser testing을 위해 agent-browser를 설정합니다.
category: deployment
area: infra
...
HarneesLab Docker image에는 agent-browser가 **미리 설치**되어 있습니다. 별도 작업은 필요하지 않습니다.
