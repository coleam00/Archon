...
│                                                                 │
│ @user commented:                                                │
│   @harneeslab fix this issue                                        │
│                                                                 │
│ ─────────────────────────────────────────────────────────────── │
│                                                                 │
│ @harneeslab commented:                                              │
...
│   │  @harneeslab_bot     │              - Real-time streaming (default)    │
│   │                  │              - DM the bot directly              │
...
│   │                  │              - DM the bot                       │
│   │  @harneeslab review  │              - Good for team visibility         │
│   │  this PR         │                                                  │
│   └──────────────────┘                                                  │
│                                                                         │
├─────────────────────────────────────────────────────────────────────────┤
...
│   │  Issue #42       │              - @harneeslab in comments              │
│   │                  │              - Batch mode (single comment)      │
│   │  @harneeslab fix     │              - Auto-creates PRs                 │
...
│   Fix a GitHub issue                "@harneeslab fix this issue"            │
│   Review a PR                       "@harneeslab review this PR"            │
│   Ask a question                    "What does handleMessage do?"       │
│   Resolve conflicts                 "@harneeslab resolve the conflicts"     │
