...
- **Provider support** — Claude, Codex, and Oh My Pi support node-scoped `mcp:`
  configs. The Pi provider warns and ignores the field; configure MCP servers
  through Pi's native config surfaces instead.
