...
export function buildOmpSettingsOverrides(
  ...
  for (const [key, value] of [
    ...
    ['compaction.strategy', settings?.compaction?.strategy],
    ['compaction.supersedeReads', settings?.compaction?.supersedeReads],
    ['compaction.dropUseless', settings?.compaction?.dropUseless],
    ['compaction.thresholdPercent', settings?.compaction?.thresholdPercent],
    ['compaction.thresholdTokens', settings?.compaction?.thresholdTokens],
    ['snapcompact.systemPrompt', settings?.snapcompact?.systemPrompt],
    ['snapcompact.toolResults', settings?.snapcompact?.toolResults],
    ['snapcompact.shape', settings?.snapcompact?.shape],
    ['contextPromotion.enabled', settings?.contextPromotion?.enabled],
    ['model.loopGuard.enabled', settings?.model?.loopGuard?.enabled],
    ...
    ['mnemopi.polyphonicRecall', settings?.mnemopi?.polyphonicRecall],
    ['mnemopi.enhancedRecall', settings?.mnemopi?.enhancedRecall],
    ['mnemopi.noEmbeddings', settings?.mnemopi?.noEmbeddings],
    ['mnemopi.debug', settings?.mnemopi?.debug],
    ['hindsight.autoRecall', settings?.hindsight?.autoRecall],
    ['hindsight.autoRetain', settings?.hindsight?.autoRetain],
    ['hindsight.debug', settings?.hindsight?.debug],
    ['hindsight.mentalModelsEnabled', settings?.hindsight?.mentalModelsEnabled],
    ['hindsight.mentalModelAutoSeed', settings?.hindsight?.mentalModelAutoSeed],
