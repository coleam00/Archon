  ...
  return (
    <Card accentColor="orange" className="overflow-hidden p-8">
      ...
      <div className="grid grid-cols-2 gap-4 text-xs text-gray-600 dark:text-gray-400">
        <div>
          <p>
            <strong>Max Prose Ratio:</strong> Maximum percentage of prose
            indicators allowed (0-1)
          </p>
          <p className="mt-1">
            <strong>Context Window:</strong> Characters of context before/after
            code blocks
          </p>
        </div>
        <div>
          <p>
            <strong>Min Code Indicators:</strong> Required code patterns
            (brackets, operators, keywords)
          </p>
          <p className="mt-1">
            <strong>Max Workers:</strong> Parallel processing for code summaries
          </p>
        </div>
      </div>
    </Card>
